...
__title__ = "7.Umluftkühlung"
__doc__ = """Schacht von Lüftung Übernehmen und Wärmeabgabe an Raum berechnen"""
...
#        umluft_zu = get_value(Space.LookupParameter("TGA_S_Schacht_zu_Umluft"))
#        umluft_ab = get_value(Space.LookupParameter("TGA_S_Schacht_ab_Umluft"))
        tabel_Date_MEP.append([nummer,name,luft_zu,luft_ab])
#        tabel_Date_MEP.append([nummer,name,luft_zu,luft_ab,umluft_zu,umluft_ab])
        if ins_schacht:
            schacht.append([nummer,name,install_schacht_name,luft_zu,luft_ab])
#            schacht.append([nummer,name,install_schacht_name,luft_zu,luft_ab,umluft_zu,umluft_ab])
...
#            ZuRaum_Schacht = Spaces.LookupParameter("TGA_S_Schacht_zu_Umluft")
#            AbRaum_Schacht = Spaces.LookupParameter("TGA_S_Schacht_ab_Umluft")
#            ZuRaum_Schacht.Set(str(Zuluft_Schacht))
#            AbRaum_Schacht.Set(str(Abluft_Schacht))
...
#            ['Zu_Schacht_Nr', 'TGA_S_Schacht_zu_Umluft'],
#            ['Waerme', 'IGF_S_WärmeAnRaum'],
#            ['Ab_Schacht_Nr', 'TGA_S_Schacht_ab_Umluft'],
        ]
...
#        Zu_Schacht_Nr = get_value(space.LookupParameter('TGA_S_Schacht_zu_Umluft'))
#        Waermeabagbe = get_value(space.LookupParameter('IGF_S_WärmeAnRaum'))
#
#
...
#    title="Gasemengen",
#    columns=[ 'Schacht','Wärmeabgabe an Raum',  ]
#)
...
#                        zuschacht = SPACE.LookupParameter('IGF_S_Schacht_Wärme_Raum')
