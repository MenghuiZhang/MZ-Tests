...
__title__ = "2.61 Kl_Bilanz_Gebäude"
__doc__ = """Kühllastberechnung bezogen auf Gebäudekühllast"""
...
class MEPRaum:
    ...
    def berechnen(self):
        ...
        ueber = self.Kuehllast_Gebaeude - self.Kuehlleistung
...
output.print_table(
    ...
    title="Luftmengen",
    columns=['Nummer', 'Name', 'Kuehllast_Gebaeude', 'Kühlleistung',
             'KL_Bilanz',
             ]
)
