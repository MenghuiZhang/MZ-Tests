...
class MEPRaum:
    ...
    def werte_schreiben(self):
        ...
        wert_schreiben("IGF_RLT_AbluftminRaumL24h", self.abluft_min_incl_Summe24h)
        ...
        wert_schreiben("IGF_RLT_AbluftmaxSummeLabor24h", self.abluft_labor_24h)
    ...
    def table_row(self):
        ...
        return [
            ...
            self.__get_element_attr("IGF_RLT_AbluftmaxSummeLabor24h"),
            self.nb_dauer,
            self.zu_nacht,
            self.ab_nacht,
