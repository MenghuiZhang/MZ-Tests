...
al_Liste = sorted(al_Liste,key=itemgetter(0,10,9))
...
#    writer.writerows(al_Liste)
column = ['Nummer', 'Name', 'Zuluft_Raum', 'Abluft_Raum', 'Ts_Zuluft', 'TS_Abluft', 'Abluft_Labor','Abluft_24h','Sys_Name',
         'Sys_Abkürzung', 'Sys_Klassifizierung', 'Kennzeichen', 'Vmin_Auslass', 'Vmax_Auslass', 'V_Nacht_Auslass', ]
luftauslassliste = al_Liste
luftauslassliste.insert(0,column)
script.dump_csv(al_Liste, 'C:\Users\werksstudent\Desktop\Microsoft Excel-Arbeitsblatt (neu).csv')
