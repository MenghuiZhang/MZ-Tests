...
class HighLightElement(IExternalEventHandler):
    ...
    def Execute(self,uiapp):
        if self.self.GUI_MEPRaum.elemId4hightlight != None:
            try:uiapp.ActiveUIDocument.Selection.SetElementIds(List[DB.ElementId]([self.self.GUI_MEPRaum.elemId4hightlight]))
            except:pass
