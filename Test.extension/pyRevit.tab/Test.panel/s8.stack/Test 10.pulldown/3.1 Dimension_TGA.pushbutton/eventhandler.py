...
from IGF_Klasse._ansicht import ObservableCollection,Ansicht
import math
import os
...
#     if el.name == 'IGF_X_Information ans Schema_Rohre':
#         Bauteilliste = el
#         break
# if not Bauteilliste:
...
class HLS:
    ...
    def get_liste(self,elem):
        ...
        if cateid not in ['-2008043','-2008122']:
            ...
            if conns:
                if conns.Size > 2 and cateid != '-2001140' and cateid != '-2008044':
                    self.wege_3 = elemid
    ...
    def get_liste(self,elem):        
        ...
        if cateid not in ['-2008043','-2008122']: # entspricht entweder RoheSystem oder Rohrdämmung
            ...
            if conns:
                ...
                elif conns.Size > 2 and cateid != '-2008044': # T-Stück
...
class Externalliste(IExternalEventHandler):
    ...
    def nummeriren(self,uiapp):
        ...
        try:
            ...
            for Id in Ids:
                ...
                if hls.wege_3 != '':
                    if hls.wege_3 not in T_Stueck_Liste:
                        ...
                        gesamt_TStueck_liste.append(hls.wege_3)
                    else:
            ...
            for n,wege_3 in enumerate(T_Stueck_Liste):
                tsnr += 1
                wege3 = TStueck(T_Stueck_Dict[wege_3],wege_3,tsnr,gesamt_TStueck_liste,doc,self.GUI.allebauteile.alle)
                    ...
                    if wege3.wege_3_0 not in ['','Enddeckel','HLS-Bauteile','Offen']:
                        if wege3.wege_3_0 not in t_stueck_neu:
                            if wege3.wege_3_0 in T_Stueck_Dict.keys():
                                ...
                                gesamt_TStueck_liste.append(wege3.wege_3_0)
                    ...
                    if wege3.wege_3_1 not in ['','Enddeckel','HLS-Bauteile','Offen']:
                        if wege3.wege_3_1 not in t_stueck_neu:
                            if wege3.wege_3_1 in T_Stueck_Dict.keys():
                                ...
                                gesamt_TStueck_liste.append(wege3.wege_3_1)
                        ...
                        if wege3.wege_3_0 not in ['','Enddeckel','HLS-Bauteile','Offen']:
                            if wege3.wege_3_0 not in t_stueck_neu_temp:
                                if wege3.wege_3_0 in T_Stueck_Dict.keys():
                                    ...
                                    T_Stueck_Dict[wege3.wege_3_0] = wege3.alle_0
                                    gesamt_TStueck_liste.append(wege3.alle_0)
    ...
    def Bauteillisteexport(self,uiapp):
        ...
        t.Commit()
        t.Dispose()
        data = Bauteilliste.get_Data_MitFormat()
