...
__title__ = "3.1 Dimensionen ins Schema übertragen"
__doc__ = """

Bauteilliste: IGF_X_Information ans Schema_Rohre
Parameter: 
...
class AktuelleBerechnung(forms.WPFWindow):
    ...
    def nummer(self,sender,args):
        self.externalliste.ExecuteApp = self.externalliste.exprotieren
        self.externallisteevent.Raise()
