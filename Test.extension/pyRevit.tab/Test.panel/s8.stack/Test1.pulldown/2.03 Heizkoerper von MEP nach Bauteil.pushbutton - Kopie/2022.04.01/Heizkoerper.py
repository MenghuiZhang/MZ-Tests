...
class HeizkoerperInstance(object):
    def __init__(self,elemid,Nl_Param,HL_Param):
        ...
        self.raumid = ''
        self.GetRaum()
        self.Nennleistung = round(self.get_value(self.Param_NL)) if round(self.get_value(self.Param_NL)) != 0 else 0.1
        self.Heizleistung = round(self.get_value(self.Param_HL)) if round(self.get_value(self.Param_HL)) != 0 else 0.1
