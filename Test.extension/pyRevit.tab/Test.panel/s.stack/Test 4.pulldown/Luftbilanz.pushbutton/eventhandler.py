...
class MEPRaum(object):
    def __init__(self, elemid,list_vsr):
        ...
        self.ab_min.soll = self.ab_min.soll - self.ab_lab_min.soll - self.ab_24h.soll
        self.ab_max.soll = self.ab_max.soll - self.ab_lab_max.soll - self.ab_24h.soll
        ...
        self.Druckstufe = MEPGrundInfo('Druckstufe',self.get_element('IGF_RLT_Druckstufe'),'IGF_RLT_Druckstufe')
