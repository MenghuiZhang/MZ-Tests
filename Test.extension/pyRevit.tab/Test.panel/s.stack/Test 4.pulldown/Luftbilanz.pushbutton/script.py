...
class MEPRaum_Uebersicht(forms.WPFWindow):
    ...
    def Auswertung_MEP(self):        
        if self.mepraum.IsTierRaum != 0:
            ...
            min_ab_sum = float(self.mepraum.ab_min.soll) + float(self.mepraum.tier_ab_min.soll) + float(self.mepraum.ueber_aus.soll) + float(self.mepraum.ab_lab_min.soll) + float(self.mepraum.ab_24h.soll)
            max_zu_sum = float(self.mepraum.zu_max.soll) + float(self.mepraum.tier_zu_max.soll) + float(self.mepraum.ueber_in.soll)
            max_ab_sum = float(self.mepraum.ab_max.soll) + float(self.mepraum.tier_ab_max.soll) + float(self.mepraum.ueber_aus.soll) + float(self.mepraum.ab_lab_max.soll) + float(self.mepraum.ab_24h.soll)
        else:
            min_zu_sum = float(self.mepraum.zu_min.soll) + float(self.mepraum.ueber_in.soll)
            min_ab_sum = float(self.mepraum.ab_min.soll) + float(self.mepraum.ueber_aus.soll) + float(self.mepraum.ab_lab_min.soll) + float(self.mepraum.ab_24h.soll)
            max_zu_sum = float(self.mepraum.zu_max.soll) + float(self.mepraum.ueber_in.soll)
            max_ab_sum = float(self.mepraum.ab_max.soll) + float(self.mepraum.ueber_aus.soll) + float(self.mepraum.ab_lab_max.soll) + float(self.mepraum.ab_24h.soll)
        ...
        if self.mepraum.nachtbetrieb != 0:
            ...
            nb_ab_sum = float(self.mepraum.nb_ab.soll) + float(self.mepraum.ueber_aus.soll) + float(self.mepraum.ab_lab_min.soll) + float(self.mepraum.ab_24h.soll)
            nb_abweichung = nb_zu_sum - nb_ab_sum
        ...
        if self.mepraum.tiefenachtbetrieb != 0:
            ...
            tnb_ab_sum = float(self.mepraum.tnb_ab.soll) + float(self.mepraum.ueber_aus.soll) + float(self.mepraum.ab_lab_min.soll) + float(self.mepraum.ab_24h.soll)
            tnb_abweichung = tnb_zu_sum - tnb_ab_sum
