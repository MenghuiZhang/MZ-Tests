...
from eventhandler import LISTE_SCHACHT,IS_Laboranschluss,IS_Schacht,ListeExternalEvent,ExternalEvent,MEPRaum,ObservableCollection,Laboranschlusss,labanschluss_Dict,LEVEL_Dict,Dict_MEPRaum
