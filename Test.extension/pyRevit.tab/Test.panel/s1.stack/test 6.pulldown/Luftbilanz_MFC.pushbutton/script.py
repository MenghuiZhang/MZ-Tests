...
from eventhandler import ResizeAnsicht,ResetAnsicht,Luftauslass,ShowElement,HighLightElement,\
    ...
    RED,BLACK,UNDO,UPDATEMODEL,VERTEILEN
...
class MEPRaum_Uebersicht(forms.WPFWindow):
    ...
    def doverteilen(self, sender, args):
        ...
        # t.Start()
        # for mep in self.mepraum_liste.values():
        #    # print(mep.Raumnr)
        #     if int(mep.ab_24h.soll) != 0 or int(mep.ab_lab_min.soll) != 0:continue
        #     zu = {}
        #     ab = {}
        ...
        #     if len(zu.keys()) == 1 and len(ab.keys()) == 1:
        #         for key in zu.keys():
