...
class MEPRaum:
    def __init__(self, element_id):
        ...
        attr = [
            ...
            ['abl_24h_nacht','IGF_RLT_NachtbetriebDauer'],
        ...
        #self.abl_24h_nacht = self.nb_dauer_berechnen()
...
#
    #    else:
    #        abl_24h_nacht = self.NB_Von - self.NB_Bis + 24:00
#
    #    logger.info("Nachtbetrieb_Dauer = {}".format(abl_24h_nacht))
    #    return abl_24h_nacht

    def abluft_nacht_berechnen(self):
        ab_nacht = 0

        if int(self.nacht) == False:
            ab_nacht = 0
...
#        ab_nacht = ab_nacht + self.ueberstroemung - sum(stroemt_ueber)
    ...
    #        if self.abluft_labor_24h > zu_nacht:
    #           logger.info(
    #             "{} m/h3 Labor und 24h Abluft berücksichtigt".format(self.abluft_labor_24h))

#               zu_nacht = self.abluft_labor_24h
#
#            if self.raum_druckstufe > 0:
#               logger.info(
#                  "{} - Druckstufe berücksichtigt".format(self.raum_druckstufe))
#
#               zu_nacht = zu_nacht + self.raum_druckstufe
    ...
    #    wert_schreiben("IGF_RLT_NachtbetriebDauer",self.abl_24h_nacht)
    ...
    def table_row(self):
        ...
        #    self.__get_element_attr("NB_Dauer"),
            self.zu_nacht,
            self.__get_element_attr("IGF_RLT_ZuluftNachtRaum"),
            self.ab_nacht,
            self.__get_element_attr("IGF_RLT_AbluftNachtRaum")
        ]
