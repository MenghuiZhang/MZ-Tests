...
class MEPRaum:
    def __init__(self, element_id):
        ...
        attr = [
            ...
            ['nachtbetrieb', 'IGF_RLT_Nachtbetreib'],
            ['NB_Von', 'IGF_RLT_NachtbetreibVon'],
            ['NB_Bis', 'IGF_RLT_NachtbetreibBis'],
            ['NB_LW', 'IGF_RLT_NachtbetreibLW']
        ]
    ...
    def werte_schreiben(self):
        ...
        wert_schreiben("IGF_RLT_NachtbetreibDauer", self.nb_dauer)
...
output.print_table(
    ...
    columns=['Nummer', 'Name', 'ZUL pyRevit', 'ZUL Excel', 'ABL pyRevit',
             'ABL Excel', 'Labor pyRevit', 'Labor Excel', 'nb Dauer', 'nb zu', 'nb_ab']
)
