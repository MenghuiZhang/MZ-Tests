...
__title__ = "2.53 K_DeS_Schacht"
__doc__ = """Schacht von Lüftung Übernehmen und Kühlleistung bzw. Wassermenge von Deckensgel in Schacht berechnen"""
...
with forms.ProgressBar(title='{value}/{max_value} Kühlleistung von Schacht Berechnen',
    ...
    for space in spaces_collector:
        ...
        Leistung = get_value(space.LookupParameter('IGF_K_DeS_Leistung'))
...
output.print_table(
    ...
    title="Schächte",
    columns=[ 'Schacht','DeS-VL_Som_Menge','DeS-RL_Som_Menge','DeS-VL_Leistung','DeS-RL_Leistung',  ]
)
