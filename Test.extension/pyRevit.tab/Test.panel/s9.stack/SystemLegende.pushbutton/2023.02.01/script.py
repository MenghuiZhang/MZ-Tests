            ...
            for el_customView in _liste:
                ...
                try:
                    ...
                    if self.auline.IsChecked:
                        ...
                        line0 = self.create_line(_View_RvtLegend,DB.XYZ(maxX_OuterLine+h_margin/2.0,minY_OuterLine-v_margin/2.0,0),DB.XYZ(maxX_OuterLine+h_margin/2.0,maxY_OuterLine+v_margin/2.0,0))
                        line1 = self.create_line(_View_RvtLegend,DB.XYZ(minX_OuterLine-h_margin/2.0,minY_OuterLine-v_margin/2.0,0),DB.XYZ(minX_OuterLine-h_margin/2.0,maxY_OuterLine+v_margin/2.0,0))
                        line2 = self.create_line(_View_RvtLegend,DB.XYZ(maxX_OuterLine+h_margin/2.0,maxY_OuterLine+v_margin/2.0,0),DB.XYZ(minX_OuterLine-h_margin/2.0,maxY_OuterLine+v_margin/2.0,0))
                        line3 = self.create_line(_View_RvtLegend,DB.XYZ(maxX_OuterLine+h_margin/2.0,minY_OuterLine-v_margin/2.0,0),DB.XYZ(minX_OuterLine-h_margin/2.0,minY_OuterLine-v_margin/2.0,0))
                        line4 = self.create_line(_View_RvtLegend,DB.XYZ(maxX_OuterLine+h_margin/2.0,maxY_OuterLine_temp+v_margin/2.0,0),DB.XYZ(minX_OuterLine-h_margin/2.0,maxY_OuterLine_temp+v_margin/2.0,0))
                    ...
                    if self.inline.IsChecked:
                        ...
                        line_temp = self.create_line(_View_RvtLegend,DB.XYZ(maxX+h_margin/2.0,minY_OuterLine-v_margin/2.0,0),DB.XYZ(maxX+h_margin/2.0,maxY_OuterLine_temp+v_margin/2.0,0))
                        ...
                        for n,el_Liste in enumerate(Liste_TextNoteWithSymbol):
                            ...
                            line_neu = self.create_line(_View_RvtLegend,DB.XYZ(minX_OuterLine-h_margin/2.0,Y_line-v_margin/2.0,0),DB.XYZ(maxX_OuterLine+h_margin/2.0,Y_line-v_margin/2.0,0))
