...
class FamilieExemplar(TemplateItemBase):
    def __init__(self,elemid,art):
        ...
        self._size = ''
        self._Luftmengensollmax = ''
        self._Luftmengensollmin = ''
        self._Anmerkung = ''
    ...
    @property
    def Luftmengensollmin(self):
        return self._Luftmengensollmin
    @Luftmengensollmin.setter
    def Luftmengensollmin(self,value):
        if value != self._Luftmengensollmin:
            self._Luftmengensollmin = value
            self.RaisePropertyChanged('Luftmengensollmin')
    
    @property
    def Luftmengensollmax(self):
        return self._Luftmengensollmax
    @Luftmengensollmax.setter
    def Luftmengensollmax(self,value):
        if value != self._Luftmengensollmax:
            self._Luftmengensollmax = value
            self.RaisePropertyChanged('Luftmengensollmax')
