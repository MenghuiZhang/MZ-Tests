        ...
        while(True):
            try:
                ...
                try:
                    ...
                    el1.get_Parameter(DB.BuiltInParameter.RBS_START_LEVEL_PARAM).Set(el0.get_Parameter(DB.BuiltInParameter.RBS_START_LEVEL_PARAM).AsElementId())
                    el1.get_Parameter(DB.BuiltInParameter.RBS_OFFSET_PARAM).Set(el0.get_Parameter(DB.BuiltInParameter.RBS_OFFSET_PARAM).AsDouble())
