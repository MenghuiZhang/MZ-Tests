...
__title__ = "1.20 erstellt Höhenkoten der Ebene"
__doc__ = """HöhenkotenEbene bezuglich Projekt-NullPunktes und realen NullPunktes"""
        ...
        for Ebe in table_Date:
            ...
            if Ebe[3] == 0:
                ...
                if any(pruefung):
                    ...
                    new_Para = DB.GlobalParameter.Create(doc,'NN',DB.ParameterType.Number)
                    # Formel und Wert
