...
__title__ = "Überströmung"
__doc__ = """Überströmung"""
            ...
            if Item.Space[phase]:
                ...
                if System_Typ == '31_Überstromluft':
                    ...
                    if Familie_Typ == 'CAx Zuluft Trassenteilstrecke RE':
                        ...
                        logger.info('Raum: {}, Unterströmung {}'.format(Raumnummer,Vol))
...
def Liste(input_list):
    ...
    for item in input_list:
        for sys in out_liste:
            if item[0] == sys[0]:
                if item[1] == 'CAx Zuluft Trassenteilstrecke RE':
                    sys[1] = item[2]
                    if item[3] > 0:
                        sys[3] = item[3]
                elif item[1] == 'CAx Abluft Trassenteilstrecke RE':
                    sys[2] = item[2]
                    if item[3] > 0:
                        sys[3] = item[3]
    return out_liste
