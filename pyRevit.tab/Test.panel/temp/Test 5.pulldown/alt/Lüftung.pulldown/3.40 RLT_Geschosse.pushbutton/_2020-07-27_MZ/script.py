                ...
                for aaa in range(len(EbenenListe)):
                    ...
                    if any(ebe_zu):
                        ...
                        for bbb in range(len(ZuAnlNrListe)):
                            if ebe_zu[bbb] > 0:
                                luft_zu = luft_zu + 'Anl ' + str(ZuAnlNrListe[bbb]) + '=' + str(ebe_zu[bbb]) + ', '
                    ...
                    if any(ebe_ab):
                        ...
                        for ccc in range(len(AbAnlNrListe)):
                            if ebe_ab[ccc] > 0:
                                luft_ab = luft_ab + 'Anl ' + str(AbAnlNrListe[ccc]) + '=' + str(ebe_ab[ccc]) + ', '
                    ...
                    if any(ebe_ab24h):
                        ...
                        for ddd in range(len(Ab24hAnlNrListe)):
                            if ebe_ab24h[ddd] > 0:
                                luft_ab24h = luft_ab24h + 'Anl ' + str(Ab24hAnlNrListe[ddd]) + '=' + str(ebe_ab24h[ddd]) + ', '
