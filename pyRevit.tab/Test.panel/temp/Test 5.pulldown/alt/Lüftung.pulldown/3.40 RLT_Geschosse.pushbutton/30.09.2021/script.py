...
with forms.ProgressBar(title='{value}/{max_value} Berechnen',
    ...
    for Space in spaces_collector:
        ...
        Abl = get_value(Space.LookupParameter('IGF_RLT_AbluftminRaumOhne24h'))
...
for Nr in range(len(SchachtListe)):
    table_data_Schacht.append([SchachtListe[Nr],Zu_Verteilen[Nr],Ab_Verteilen[Nr],Ab24h_Verteilen[Nr]])
