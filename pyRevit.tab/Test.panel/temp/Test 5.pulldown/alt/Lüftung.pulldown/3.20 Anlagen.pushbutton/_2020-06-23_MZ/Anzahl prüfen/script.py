...
if len(Fehlende_Info) > 0:
    logger.error('keine Informationen zur Geräteanzahl/AnlagenProzentualAnzahl/Gerätenummer in den folgenden Systemen')
    logger.error('{}'.format(Fehlende_Info))
    logger.error('Bitte ergänzen Sie diese Informationen')
    script.exit()
