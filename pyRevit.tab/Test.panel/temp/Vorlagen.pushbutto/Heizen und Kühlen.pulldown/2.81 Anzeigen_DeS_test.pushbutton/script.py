...
__title__ = "2.82 Heiz-/Kühllast Test"
...
AllHLSNamen.sort()
AllHLSParam.sort()
class HLS_Name(object):
    def __init__(self):
        self.IsClecked = False
        self.Name = ''
    ...
    @property
    def IsClecked(self):
        return self._IsClecked
    @IsClecked.setter
    def IsClecked(self, value):
        self._IsClecked = value

AllHLSNamenList = []
for item in AllHLSNamen:
    temp = HLS_Name()
    temp.Name = item
    AllHLSNamenList.append(temp)
...
class FamilienBearbeiten(WPFWindow):
    def __init__(self, xaml_file_name,listeHuK,listeHuKVer):
        ...
        #    self.Faname.ItemsSource = AllHLSNamenList
