...
class TransitionFitting(IExternalEventHandler):
    ...
    def Execute(self,app):
        ...
        el0_ref = uidoc.Selection.PickObject(Selection.ObjectType.Element,'Wählt den ersten Luftkanal aus')
        el1_ref = uidoc.Selection.PickObject(Selection.ObjectType.Element,'Wählt den zweiten Luftkanal aus')
            ...
            if self.GUI.auto.IsChecked:
                ...
                if co_fi.IsConnectedTo(co1):
                    ...
                    try:
                        ...
                        doc.Regenerate()
                        fi.LookupParameter('L').Set(int(self.GUI.manuell.Content)/304.8)
                        doc.Regenerate()
                        fi.Location.Move(o1-co1.Origin)
                    except:pass
...
class TransitionFitting1(IExternalEventHandler):
    ...
    def Execute(self,app):
        ...
        el0_ref = uidoc.Selection.PickObject(Selection.ObjectType.Element,'Wählt den fixierten Luftkanal aus')
        el1_ref = uidoc.Selection.PickObject(Selection.ObjectType.Element,'Wählt die Übergang aus')
        el0 = doc.GetElement(el0_ref)
        el1 = doc.GetElement(el1_ref)
