...
class MEPRaum(object):
    ...
    def Tagesbetrieb_Berechnen(self):
        ...
        if self.bezugsname == 'nurZU_Fläche':
            ...
            self.angezuluft = self.luft_round(self.flaeche * float(self.faktor)) + self.Druckstufe.soll
            ...
            self.angezuluft = self.luft_round(self.volumen * float(self.faktor)) + self.Druckstufe.soll
            abweichung2 = self.ueber_in.soll + self.ueber_in_manuell.soll - self.ueber_aus.soll - self.ueber_aus_manuell.soll - self.ab_lab_min.soll - self.ab_24h.soll- self.Druckstufe.soll
            if abweichung2 < 0:
                self.angezuluft -= abweichung2
                self.ab_min.soll = 0
            ...
            self.angezuluft = self.luft_round(self.personen * float(self.faktor)) + self.Druckstufe.soll
            abweichung2 = self.ueber_in.soll + self.ueber_in_manuell.soll - self.ueber_aus.soll - self.ueber_aus_manuell.soll - self.ab_lab_min.soll - self.ab_24h.soll- self.Druckstufe.soll
            if abweichung2 < 0:
                self.angezuluft -= abweichung2
                self.ab_min.soll = 0
    ...
    def werte_schreiben(self):
        ...
        wert_schreiben("IGF_RLT_Luftmenge_RAB", self.ab_min.soll+self.ab_lab_min.soll)
...
class VERTEILEN(IExternalEventHandler):
    ...
    def Execute(self,app):
        ...
        for mep in self.GUI_MEPRaum.mepraum_liste.values():
            ...
            if int(mep.ab_24h.soll) != int(mep.ab_24h.ist) or int(mep.ab_lab_min.soll) != int(mep.ab_lab_min.ist):
                print(mep.Raumnr)
                continue
            if int(mep.zu_min.soll) > 0 and len(zu.keys()) == 0:
                print(mep.Raumnr)
                continue
            if int(mep.ab_min.soll) > 0 and len(ab.keys()) == 0:
                print(mep.Raumnr)
                continue
